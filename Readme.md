...
* Windows Server 2019
  + After installing Node.js, install the **build tools** with this one-liner. Start PowerShell as Administrator and run:
    ```
    npm install --global windows-build-tools
    ```
    It will take **10** - **15** minutes to install. Here is a preview of output In Windows Server 2019:
